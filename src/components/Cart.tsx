      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center py-16">
          ...
          <button
            ...
            className="bg-primary text-white px-6 py-3 rounded-full hover:bg-primary-700 transition-all duration-200"
          >
            Browse Menu
          </button>
        </div>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        ...
        <div className="flex items-center justify-between sm:justify-center flex-1">
          <h1 className="text-2xl sm:text-3xl font-semibold text-black">Your Cart</h1>
          <button
            onClick={clearCart}
            ...
            <div className="block sm:hidden">
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1 pr-3">
                  <h3 className="text-base font-medium text-black mb-1">{item.name}</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center justify-between text-2xl font-semibold text-black mb-6">
          <span>Total:</span>
        ...
        <button
          onClick={onCheckout}
          className="w-full bg-primary text-white py-4 rounded-xl hover:bg-primary-700 transition-all duration-200 transform hover:scale-[1.02] font-medium text-lg"
        >
          Proceed to Checkout
        </button>
      </div>
